...
const MdContent = await readFile("D:/WORK/Portfolio/next/balady-mastra/src/mastra/rag/md/rag.md", "utf-8")
...
const store = await LanceVectorStore.create('./src/mastra/rag/db')
...
// npx tsx src/mastra/rag/store.ts